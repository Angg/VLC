...
#
# Generated by Vivado on Tue Dec 19 11:00:13 +0700 2017
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/axis_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/Tx_Design/ip/Tx_Design_FrameAssembler_BRAM_0_1/sim/Tx_Design_FrameAssembler_BRAM_0_1.v" \
    ...
    "$ref_dir/../../../bd/Tx_Design/ip/Tx_Design_HermitianBuffer_BRAM_0_1/sim/Tx_Design_HermitianBuffer_BRAM_0_1.v" \
  2>&1 | tee -a vlogan.log
