...
/* Definitions for driver RESETREG */
#define XPAR_RESETREG_NUM_INSTANCES 1

/* Definitions for peripheral RESETREG_0 */
#define XPAR_RESETREG_0_DEVICE_ID 0
#define XPAR_RESETREG_0_S00_AXI_BASEADDR 0x43C10000
#define XPAR_RESETREG_0_S00_AXI_HIGHADDR 0x43C1FFFF


/******************************************************************/

/* Definitions for driver TXINPUTBUFFER */
#define XPAR_TXINPUTBUFFER_NUM_INSTANCES 1

/* Definitions for peripheral TXINPUTBUFFER_0 */
#define XPAR_TXINPUTBUFFER_0_DEVICE_ID 0
#define XPAR_TXINPUTBUFFER_0_S00_AXI_BASEADDR 0x43C00000
#define XPAR_TXINPUTBUFFER_0_S00_AXI_HIGHADDR 0x43C0FFFF
