...
CONFIG.branch_length_constant {1} \
CONFIG.col_port_width {4} \
CONFIG.minimum_columns {15} \
CONFIG.minimum_rows {15} \
CONFIG.number_of_branches {16} \
CONFIG.number_of_columns_constant_value {14} \
CONFIG.number_of_rows_constant_value {16} \
...
CONFIG.DOUT_WIDTH {8} \
  ...
  connect_bd_intf_net -intf_net FrameAssembler_BRAM_0_M00_AXIS [get_bd_intf_pins FrameAssembler_BRAM_0/M00_AXIS] [get_bd_intf_pins axis_data_fifo_2/S_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets FrameAssembler_BRAM_0_M00_AXIS]
  connect_bd_intf_net -intf_net HermitianBuffer_BRAM_0_M00_AXIS [get_bd_intf_pins HermitianBuffer_BRAM_0/M00_AXIS] [get_bd_intf_pins axis_data_fifo_1/S_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets HermitianBuffer_BRAM_0_M00_AXIS]
  ...
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets QPSK_mapper_0_M00_AXIS]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins HermitianBuffer_BRAM_0/S00_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets axis_data_fifo_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets convolution_0_M_AXIS_DATA]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins TxInputBuffer_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets sid_0_M_AXIS_DATA]
  ...
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets FrameAssembler_BRAM_0_s00_axis_tready]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  connect_bd_net -net TxInputBuffer_0_m00_axis_tdata [get_bd_pins TxInputBuffer_0/m00_axis_tdata] [get_bd_pins xlslice_1/Din]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets TxInputBuffer_0_m00_axis_tdata]
  connect_bd_net -net TxInputBuffer_0_m00_axis_tvalid [get_bd_pins TxInputBuffer_0/m00_axis_tvalid] [get_bd_pins convolution_0/s_axis_data_tvalid]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets TxInputBuffer_0_m00_axis_tvalid]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  connect_bd_net -net convolution_0_s_axis_data_tready [get_bd_pins TxInputBuffer_0/m00_axis_tready] [get_bd_pins convolution_0/s_axis_data_tready]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets convolution_0_s_axis_data_tready]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins FrameAssembler_BRAM_0/m00_axis_aclk] [get_bd_pins FrameAssembler_BRAM_0/s00_axis_aclk] [get_bd_pins HermitianBuffer_BRAM_0/m00_axis_aclk] [get_bd_pins HermitianBuffer_BRAM_0/s00_axis_aclk] [get_bd_pins QPSK_mapper_0/aclk] [get_bd_pins ResetReg_0/s00_axi_aclk] [get_bd_pins TxInputBuffer_0/m00_axis_aclk] [get_bd_pins TxInputBuffer_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_data_fifo_2/s_axis_aclk] [get_bd_pins convolution_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins sid_0/aclk] [get_bd_pins xfft_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins FrameAssembler_BRAM_0/m00_axis_aresetn] [get_bd_pins FrameAssembler_BRAM_0/s00_axis_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins HermitianBuffer_BRAM_0/m00_axis_aresetn] [get_bd_pins HermitianBuffer_BRAM_0/s00_axis_aresetn] [get_bd_pins QPSK_mapper_0/aresetn] [get_bd_pins ResetReg_0/s00_axi_aresetn] [get_bd_pins TxInputBuffer_0/m00_axis_aresetn] [get_bd_pins TxInputBuffer_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_2/s_axis_aresetn] [get_bd_pins convolution_0/aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins xfft_0/aresetn]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins convolution_0/s_axis_data_tdata] [get_bd_pins xlslice_1/Dout]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs TxInputBuffer_0/S00_AXI/S00_AXI_reg] SEG_TxInputBuffer_0_S00_AXI_reg
...
preplace inst axis_data_fifo_1 -pg 1 -lvl 7 -y 460 -defaultsOSRD
preplace inst axis_data_fifo_2 -pg 1 -lvl 11 -y 460 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 9 -y 370 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 12 -y 430 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 1 -y 330 -defaultsOSRD
...
preplace inst FrameAssembler_BRAM_0 -pg 1 -lvl 10 -y 440 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 7 -y 650 -defaultsOSRD
preplace inst HermitianBuffer_BRAM_0 -pg 1 -lvl 6 -y 440 -defaultsOSRD
preplace inst xfft_0 -pg 1 -lvl 8 -y 480 -defaultsOSRD
preplace inst convolution_0 -pg 1 -lvl 2 -y 410 -defaultsOSRD
preplace inst sid_0 -pg 1 -lvl 3 -y 420 -defaultsOSRD
preplace inst TxInputBuffer_0 -pg 1 -lvl 12 -y 240 -defaultsOSRD
preplace inst QPSK_mapper_0 -pg 1 -lvl 4 -y 410 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 13 -y 470 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 5 -y 430 -defaultsOSRD
preplace inst ResetReg_0 -pg 1 -lvl 12 -y 80 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 11 -y 190 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 14 -y 680 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 14 1 NJ
preplace netloc xlconstant_1_dout 1 7 1 NJ
preplace netloc sid_0_M_AXIS_DATA 1 3 1 N
preplace netloc xfft_0_m_axis_data_tlast 1 8 2 NJ 320 3000
preplace netloc xlslice_1_Dout 1 1 1 NJ
preplace netloc TxInputBuffer_0_m00_axis_tdata 1 0 13 20 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 350 NJ 330 4140
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 11 1 3740
preplace netloc processing_system7_0_M_AXI_GP0 1 10 5 3350 10 NJ 10 NJ 10 NJ 10 4970
preplace netloc FrameAssembler_BRAM_0_s00_axis_tready 1 8 2 NJ 430 N
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 15 20 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 NJ 780 4960
preplace netloc FrameAssembler_BRAM_0_M00_AXIS 1 10 1 N
preplace netloc axi_mem_intercon_M00_AXI 1 13 1 4510
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 11 1 3720
preplace netloc axi_dma_0_s2mm_introut 1 12 2 4180 720 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 12 380 510 NJ 510 1080 480 1340 520 1700 540 1990 700 2360 640 NJ 640 NJ 640 3350 540 3750 530 4210
preplace netloc convolution_0_M_AXIS_DATA 1 2 1 N
preplace netloc xfft_0_m_axis_data_tdata 1 8 1 NJ
preplace netloc xlconstant_0_dout 1 7 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 14 1 NJ
preplace netloc ResetReg_0_RESET_S 1 0 13 40 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 4170
preplace netloc axi_dma_0_M_AXI_S2MM 1 12 1 N
preplace netloc xfft_0_m_axis_data_tvalid 1 8 2 NJ 420 3000
preplace netloc axis_data_fifo_0_M_AXIS 1 5 1 N
preplace netloc axis_data_fifo_1_M_AXIS 1 7 1 N
preplace netloc QPSK_mapper_0_M00_AXIS 1 4 1 N
preplace netloc convolution_0_s_axis_data_tready 1 1 12 390 750 NJ 750 NJ 750 NJ 750 NJ 750 NJ 750 NJ 750 NJ 750 NJ 750 NJ 750 NJ 750 4150
preplace netloc TxInputBuffer_0_m00_axis_tvalid 1 1 12 400 740 NJ 740 NJ 740 NJ 740 NJ 740 NJ 740 NJ 740 NJ 740 NJ 740 NJ 740 NJ 740 4160
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 12 NJ 550 NJ 550 NJ 550 NJ 550 NJ 550 NJ 730 NJ 730 NJ 580 3010 580 3330 550 NJ 550 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 15 30 540 370 520 720 500 1070 490 1350 510 1690 530 2000 710 2350 630 NJ 590 3000 590 3320 30 3730 520 4200 680 4510 770 4970
preplace netloc HermitianBuffer_BRAM_0_M00_AXIS 1 6 1 N
preplace netloc axis_data_fifo_2_M_AXIS 1 11 1 3720
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 11 1 3720
preplace netloc xlslice_0_Dout 1 9 1 N
levelinfo -pg 1 0 200 560 920 1230 1540 1860 2180 2600 2910 3180 3570 3980 4360 4760 4990 -top 0 -bot 790
",
}
