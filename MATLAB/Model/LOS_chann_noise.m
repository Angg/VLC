function [ SNR_dB ] = LOS_chann_noise( theta, lx, ly, h, P_total, Adet, Rdet, Rb, No )
%LOS_CHANN_NOISE function is used to calculate SNR value from the
%LOS channel room parameter inputted by the user
